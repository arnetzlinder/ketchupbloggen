let recepies: {
  ...
  //Array which stores all info about the recepies, e.g. name
  {
    ...
    name: 'Ketchupsoppa',
    figcaption:
      'Krämig soppa med lena smaker där ketchup står för den oväntade smaksensationen som förhöjer hela upplevelsen',
    ingredient:
      '<ul><li>4 msk Smör </li> <li> 1 st Gul lök </li><li>  1 kg Tomater </li><li> 1 st Lagerblad </li><li> 4 kvistar Basilika </li><li> 4 kvistar Persilja </li><li> 2 liter Grönsaksbuljong </li><li> 1 msk Tomatketchup </li><li> 1 dl Vispgrädde</li></ul>',
