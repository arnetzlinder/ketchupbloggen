let recepies: {id: number; figcaption: string; name: string; ingredient: string; desc: string; images: {img: string; alt: string;}[] } [] = [
    //Array which stores all info about the recepies, e.g. name
    {
      ...
      name: "Ketchupsoppa",
      figcaption: "Krämig soppa med lena smaker där ketchup står för den oväntade smaksensationen som förhöjer hela upplevelsen",
